...
const ViewBookDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      const res = await axios.get(
        `https://my-book-store-tgmm.onrender.com/api/v1/get-book-by-id/${id}`
      );
  ...
  const addToFavourite = async () => {
    try {
      const response = await axios.put(
        "https://my-book-store-tgmm.onrender.com/api/v1/add-to-favourite",
        {},
        { headers }
      );
      toast(
  ...
  const addToCart = async () => {
    try {
      const response = await axios.put(
        "https://my-book-store-tgmm.onrender.com/api/v1/add-to-cart",
        {},
        { headers }
      );
  ...
  const deleteBook = async () => {
    try {
      const response = await axios.delete(
        "https://my-book-store-tgmm.onrender.com/api/v1/delete-book",
        { headers }
      );
      toast.success(response.data.message, {
        style: {
